...
function PricingPoints({li}){
    ...
    return (
			<div className="flex gap-2 w-fit pl-10 pb-2  ">
				<span>
					<i className="bx bx-check bx-xs text-blue-normal bg-card-blue-normal p-1 rounded-full"></i>
				</span>
				<p className="text-gray-normal font-medium  text-sm">{li}</p>
			</div>
		)
}
...
function PricingCard({image, title, price, points}) {
  return (
		<div className="rounded-xl w-[28%] bg-white flex-col mb-10 pb-10">
			...
			<div className="text-center transition-all duration-200 ease-in-out whitespace-nowrap hover:bg-blue-normal mx-auto hover:text-light-blue-normal bg-light-blue-normal text-blue-normal rounded-xl w-[80%] py-2 ">
				Buy
			</div>
		</div>
	)
